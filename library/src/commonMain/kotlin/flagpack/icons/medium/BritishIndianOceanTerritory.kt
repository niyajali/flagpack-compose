...
/**
 * British Indian Ocean Territory Flag (20x15dp)
 *
 * - ISO Alpha-2: IO
 * - ISO Alpha-3: IOT
 * - ISO Numeric: 086
 ...
 */
public val FlagIcons.Medium.BritishIndianOceanTerritory: ImageVector
    get() {
...
private fun BritishIndianOceanTerritoryPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(
            imageVector = FlagIcons.Medium.BritishIndianOceanTerritory,

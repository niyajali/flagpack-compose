 ...
 */
public val FlagIcons.Medium.SaintVincentAndTheGrenadines: ImageVector
    get() {
        if (_saintVincentAndTheGrenadines != null) {
            return _saintVincentAndTheGrenadines!!
        }
        _saintVincentAndTheGrenadines = ImageVector.Builder(
...
private var _saintVincentAndTheGrenadines: ImageVector? = null
